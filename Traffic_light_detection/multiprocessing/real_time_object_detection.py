...
while True:
	...
	if not ret:
		...
		break
	start_imresize = datetime.datetime.now()
	frame = imutils.resize(frame, width=400)
	end_imresize = datetime.datetime.now()-start_imresize
	print("[TIMESTAMP]: Time elapsed resizing image: ")
	print(end_imresize.microseconds)
	...
	start_prettydrawing = datetime.datetime.now()
	...
	end_prettydrawing = datetime.datetime.now() - start_prettydrawing
	print("[TIMESTAMP]: Time elapsed doing pretty drawing: ")
	print(end_prettydrawing.microseconds)
